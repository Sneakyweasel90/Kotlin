...
object Collections {
    ...
    val aList: List<Int> = listOf(1,2,3,4) //List is an interface //immutable
    //main APIL index an element + size of that list
    ...
    //mutable sets
    val mutableSet = mutableListOf(1,2,3,4,1,2,3)
    ...
    val hadAlice = phonebook.contains("Alice")
